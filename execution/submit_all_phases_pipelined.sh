...
# 2. Enqueue Phase 2 (Pyramids & Defenses, runs when Phase 1 finishes)
P2_OUT=$(sbatch --dependency=afterany:$P1_ID execution/submit_phase2_corrugations.sbatch)
echo "$P2_OUT"
...
echo "Phase 2 Array Enqueued (afterany:$P1_ID): $P2_ID"
...
# 4. Enqueue Master Analyzer (runs when Phase 3 finishes)
