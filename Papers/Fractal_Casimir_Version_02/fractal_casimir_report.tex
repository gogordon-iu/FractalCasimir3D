...
\begin{itemize}
    ...
    \item \textbf{2.5x Relaxed Alignment Tolerance}: The maximum allowable tilt angle before edge contact is $\phi_{\rm max} \approx 2d/L$. At $d = 250$ nm, $\phi_{m max} \approx 14.3^\circ$ (compared to $5.7^\circ$ at $d=100$ nm), drastically reducing stiction risks during AFM alignment.
